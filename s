...
local cfglocation = "stormtcfg/" 
makefolder("stormtcfg") 
...
function library:New(name) 
	...
	stormt.Name = "electric boogalo" 
	stormt.ResetOnSpawn = false 
	stormt.ZIndexBehavior = "Global" 
	stormt.DisplayOrder = 420133769 

	local UIScale = INST("UIScale") 
	UIScale.Parent = stormt 
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key) 
		if key.KeyCode == Enum.KeyCode.Insert then 
			stormt.Enabled = not stormt.Enabled 
			library.uiopen = stormt.Enabled 
		end 
	end) 
	...
	do 
		...
		TextLabel.BorderColor3 = COL3RGB(190, 0, 190) 
	...
	TextLabel.Size = UDIM2(0, txt:GetTextSize(name, 15, Enum.Font.Sarpanch, Vec2(700, TextLabel.AbsoluteSize.Y)).X, 0, 29) 
	TextLabel.Font = Enum.Font.Sarpanch 
	TextLabel.Text = name 
	TextLabel.TextColor3 = COL3RGB(255, 255, 255) 
	...
	function menu:Tab(text) 
		...
		TextButton.Size = UDIM2(0, txt:GetTextSize(text, 15, Enum.Font.Sarpanch, Vec2(700,700)).X+12, 1, 0) 
		...
		TextButton.MouseButton1Down:Connect(function() 
			if currenttab ~= text then 
				...
				library:Tween(TextButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(190, 0, 190)}) 
				currenttab = text 
				TabGui.Visible = true 
			end 
		end) 
		...
		function Tab:MSector(text, side) 
			...
			SectionText.Font = Enum.Font.Sarpanch 
			...
			function MSector:Tab(text) 
				...
				TextButton.Size = UDIM2(0, txt:GetTextSize(text, 14, Enum.Font.Sarpanch, Vec2(700,700)).X + 2, 1, 0) 
				TextButton.Font = Enum.Font.Sarpanch 
				TextButton.Text = text 
				...
				TextButton.MouseButton1Down:Connect(function() 
					...
					tab1.Visible = true 
					library:Tween(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(190, 0, 190)}) 
				end) 
				...
				function tab:Element(type, text, data, callback) 
					...
					if type == "Jumbobox" then 
						...
						Drop.ZIndex = 5 
						Drop.ScrollBarImageColor3 = COL3RGB(190, 0, 190) 
							...
							do 
								...
								Button.MouseButton1Down:Connect(function() 
									if TBLFIND(Element.value.Jumbobox, v) then 
										...
										library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(190, 0, 190)}) 
									end 
									updatetext() 
							...
							for i,v in pairs(Drop:GetChildren()) do 
								if v.Name ~= "UIListLayout" then 
									if TBLFIND(val.Jumbobox, v.Name) then 
										v.TextLabel.TextColor3 = COL3RGB(190, 0, 190)
									else 
					...
					elseif type == "ToggleKeybind" then 
						...
						Color.Name = "Color" 
						Color.Parent = Button 
						Color.BackgroundColor3 = COL3RGB(190, 0, 190)
						...
						local function update() 
							if Element.value.Toggle then 
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(190, 0, 190)}) 
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)}) 
							else 
								keybindremove(text) 
						...
						do 
							...
							Keybind.Size = UDIM2(0,txt:GetTextSize("NONE", 14, Enum.Font.Sarpanch, Vec2(700, 12)).X + 5,0, 12) 
							Keybind.AutoButtonColor = false 
							Keybind.Font = Enum.Font.Sarpanch 
							...
							Always.Text = "Always" 
							Always.TextColor3 = COL3RGB(190, 0, 190)
							...
							for _,button in pairs(Frame:GetChildren()) do 
								if button:IsA("TextButton") then 
									button.MouseButton1Down:Connect(function() 
										...
										button.TextColor3 = COL3RGB(190, 0, 190) 
										values[tabname][sectorname][tabtext][text] = Element.value 
										callback(Element.value) 
									end) 
									button.MouseEnter:Connect(function() 
										if Element.value.Type ~= button.Text then 
											library:Tween(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(190, 0, 190)}) 
										end 
									end) 
									button.MouseLeave:Connect(function() 
										if Element.value.Type ~= button.Text then 
							...
							Keybind.MouseButton1Down:Connect(function() 
								if not binding then 
									...
									binding = true 
									Keybind.Text = "..." 
									Keybind.Size = UDIM2(0,txt:GetTextSize("...", 14, Enum.Font.Sarpanch, Vec2(700, 12)).X + 4,0, 12) 
								end 
							end) 
							...
							game:GetService("UserInputService").InputBegan:Connect(function(input) 
								...
								if binding then 
									...
									Keybind.Size = UDIM2(0,txt:GetTextSize(Keybind.Text, 14, Enum.Font.Sarpanch, Vec2(700, 12)).X + 5,0, 12) 
									...
									if input.KeyCode.Name == "Backspace" then 
										Keybind.Text = "NONE" 
										Keybind.Size = UDIM2(0,txt:GetTextSize(Keybind.Text, 14, Enum.Font.Sarpanch, Vec2(700, 12)).X + 4,0, 12) 
					...
					elseif type == "ToggleColor" then 
						...
						ColorP.Font = Enum.Font.Sarpanch 
						ColorP.Text = "" 
						...
						HueFrameGradient.Color = ColorSequence.new { 
							...
							ColorSequenceKeypoint.new(0.83, COL3RGB(190, 0, 190)), 
					...
					elseif type == "ToggleTrans" then 
						...
						TextLabel.Parent = Button 
						TextLabel.BackgroundColor3 = COL3RGB(190, 0, 190) 
						TextLabel.BackgroundTransparency = 1.000 
						TextLabel.Position = UDIM2(0, 32, 0, -1) 
						TextLabel.Size = UDIM2(0.111913361, 208, 1, 0) 
						TextLabel.Font = Enum.Font.Sarpanch 
					...
					elseif type == "Slider" then 
						...
						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, COL3RGB(190, 0, 190)), ColorSequenceKeypoint.new(1, COL3RGB(190, 0, 190))} 
					...
					elseif type == "Button" then 
						...
						Button_2.MouseButton1Down:Connect(function() 
							TextLabel.TextColor3 = COL3RGB(190, 0, 190)
						...
						Button_2.MouseEnter:Connect(function() 
							library:Tween(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(190, 0, 190)}) 
						end) 
			...
			function Sector:Element(type, text, data, callback) 
				...
				if type == "ScrollDrop" then 
					...
					for i,v in ipairs(joe) do 
						do 
							...
							Frame.ScrollBarImageColor3 = COL3RGB(190, 0, 190)      
								...
								for _,bad in pairs(v.Frame:GetChildren()) do      
									if bad:IsA("TextButton") then      
										...
										if bad.Name == Element.value.Scroll[v.Name] then      
											bad.TextLabel.TextColor3 = COL3RGB(190, 0, 190)     
										end      
									end      
								end      
							end      
				...
				elseif type == "Scroll" then      
					...
					function Element:SetValue(val)      
						...
						library:Tween(Frame[Element.value.Scroll].TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(190, 0, 190)})      
						values[tabname][sectorname][text] = Element.value      
						callback(Element.value)      
					end      
					values[tabname][sectorname][text] = Element.value      
...
makefolder("stormtlua") 

local allluas = {} 

for _,lua in pairs(listfiles("stormtlua")) do 
	local luaname = GSUB(lua, "stormtlua\\", "") 
...
luascripts:Element("Button", "load", {}, function() 
	loadstring(readfile("stormtlua\\"..values.luas["lua scripts"].lua.Scroll))() 
end) 
luascripts:Element("Button", "stormtap", nil, function()
...
aimbot:Element("Dropdown", "prediction type", {options = {"off", "Storm.Tap", "bloxsense.gay", "ova.rocks", "nixus"}})  
...
aimbot:Element("Dropdown", "autoshoot type", {options = {"storm" ,"standard", "off"}})
aimbot:Element("Toggle", "autowall")
aimbot:Element("Dropdown", "autowall type", {options = {"storm", "standard", "off"}})
...
antiaim:Element("Dropdown", "pitch", {options = {"up", "down", "random", "custom", "stormtap", "Random AA", "God", "fucker"}})
...
chat:Element("Toggle", "chat spam", nil, function(tbl) 
	if tbl.Toggle then 
		while values.misc.chat["chat spam"].Toggle do 
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "Winning" and "Storm.Tap winning$$" or "Storm.Tap Nigga", false, "Innocent", false, true) 
			wait(values.misc.chat["speed (ms)"].Slider/1000) 
			 
		end 
	end 
end) 
chat:Element("Dropdown", "type", {options = {"Winning", "Storm.Tap"}}) 
...
animations:Element("Dropdown", "animation", {options = {"Default", "Floss", "barrel roll", "lil nas x", "dolphin", "monkey", "Sit", "Under", "sleep"}}, function(tbl)
	Dance.AnimationId = tbl.Dropdown == "Default" and "rbxassetid://3732699835" or tbl.Dropdown == "Floss" and "rbxassetid://5917459365" or tbl.Dropdown == "barrel roll" and "rbxassetid://136801964" or tbl.Dropdown == "lil nas x" and "rbxassetid://5938396308" or tbl.Dropdown == "dolphin" and "rbxassetid://5938365243" or tbl.Dropdown == "monkey" and "rbxassetid://3716636630" or tbl.Dropdown == "Sit" and "rbxassetid://507768133" or tbl.Dropdown == "Under" and "rbxassetid://3576719440" or tbl.Dropdown == "sleep" and "rbxassetid://7690987462"
...
RunService.RenderStepped:Connect(function(step) 
	...
	if PlayerIsAlive then 
											...
											if #Hits == 0 then
												...
												if Damage >= Stats["minimum damage"].Slider then
													...
													if values.rage.aimbot["automatic fire"].Dropdown == "standard" then
														Client.firebullet()
														if values.rage.exploits["triple tap"].Toggle and values.rage.exploits["double tap"].Active then
															Client.firebullet()
                                                                                                                        Client.firebullet()
                                                                                                                        Client.firebullet()
														end
		...
		if values.rage.angles.enabled.Toggle and not DisableAA then 
			...
			local Pitch = values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "stormtap" and -6 or values.rage.angles["pitch"].Dropdown == "random" and RANDOM(-10, 10)/10 or values.rage.angles["pitch"].Dropdown == "custom" and values.rage.angles["pitch angle"].Slider or values.rage.angles["pitch"].Dropdown == "huge" and math.huge or values.rage.angles["pitch"].Dropdown == "God" and 15 or values.rage.angles["pitch"].Dropdown == "Random AA" and RANDOM(-1362, 2337)/5078 or values.rage.angles["pitch"].Dropdown == "God" and 15 or 2.5
			if values.rage.angles["extend pitch"].Toggle and (values.rage.angles["pitch"].Dropdown == "up" or values.rage.angles["pitch"].Dropdown == "down" or values.rage.angles["pitch"].Dropdown == "stormtap" or values.rage.angles["pitch"].Dropdown == "180") then 
				Pitch = (Pitch*2)/1.6 
			end 
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current) 
	...
	if values.misc.chat["kill say"].Toggle then 
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "Storm.Tap" and values.misc.chat["message"].Text or "Storm.Tap on top", false, "Innocent", false, true) 
	end 
end) 
